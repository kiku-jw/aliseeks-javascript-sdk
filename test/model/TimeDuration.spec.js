...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AliseeksApi.TimeDuration();
  });
  ...
  describe('TimeDuration', function() {
    it('should create an instance of TimeDuration', function() {
      // uncomment below and update the code to test TimeDuration
      //var instance = new AliseeksApi.TimeDuration();
      //expect(instance).to.be.a(AliseeksApi.TimeDuration);
    });
