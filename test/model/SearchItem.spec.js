...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AliseeksApi.SearchItem();
  });
  ...
  describe('SearchItem', function() {
    it('should create an instance of SearchItem', function() {
      ...
      //var instance = new AliseeksApi.SearchItem();
      //expect(instance).to.be.a(AliseeksApi.SearchItem);
    });
    ...
    it('should have the property lotUnit (base name: "lotUnit")', function() {
      // uncomment below and update the code to test the property lotUnit
      //var instance = new AliseeksApi.SearchItem();
      //expect(instance).to.be();
    });
